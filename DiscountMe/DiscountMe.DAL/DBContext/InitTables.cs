namespace DiscountMe.DAL.DBContext {
    public class InitTables {
        public static void CreateCountries(DiscountMeDbContext context) {
            context.Database.ExecuteSqlCommand(@"INSERT INTO Countries (Name) 
        ...
        private static void ProinciasDeUruguay(DiscountMeDbContext context) {
            context.Database.ExecuteSqlCommand(@"Insert into Provinces (Name, CountryId)
        ...
        private static void CiudadesDeAlicante(DiscountMeDbContext context) {
            context.Database.ExecuteSqlCommand(@"Insert into Cities(ProvinceId, Name)
        ...
        private static void CiudadesDeMalaga(DiscountMeDbContext context) {
            context.Database.ExecuteSqlCommand(@"Insert into Cities (Name, ProvinceId)
        ...
        public static void CreateDiscountCategories(DiscountMeDbContext context) {
            context.Database.ExecuteSqlCommand(@"Insert into DiscountCategories (Name, Description)
...
//                select 36.717574, -4.445043;");
        ...
        public static void CreateFakeAddress(DiscountMeDbContext context) {
            context.Database.ExecuteSqlCommand(@"Insert into Addresses (Street, PostalCode,
            CityId)
            select 'c/ Prueba 1', '29010', 67;");
        }

        public static void CreateFakeAdvertiser(DiscountMeDbContext context) {
            context.Database.ExecuteSqlCommand(@"Insert into Advertisers (Name, Surname, UserName, Website,
                ...
                '20111023 0:0:0', '20111023 0:0:0', '20111023 0:0:0', null, 1, 0, null, null, null, null, 36.7178, -4.446, 1;");
        }

        public static void CreateFakeDiscounts(DiscountMeDbContext context) {
            context.Database.ExecuteSqlCommand(@"Insert into Discounts (ProductName,
                Description, Price, DiscountPercent, StockQuantity, StockWarningLevel, FromDate, UntilDate,
                IsPublished, Comment, AdvertiserId ,DiscountCategoryId) 
        ...
        {
            context.Database.ExecuteSqlCommand(@"Insert into User (Name, Surname, UserName, Password, Email, PasswordSalt, CreateDate,
                LastModifiedDate, LastLoginDate, LastLoginIp, IsActivated, IsLockedOut, LastLockedOutDate, NewPasswordKey, NewPasswordRequestedDate,
                NewEmailKey) 
